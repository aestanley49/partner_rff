...
ggplot(data = modno_orglist_noparnters_noM, mapping = aes(x=nopartersperpartner)) + geom_bar() + scale_x_continuous(name ="Number of Partners", limits=c(-1,140)) + scale_y_continuous(name ="Frequency", limits=c(0,17))
...
ggplot(colsum_noM) + geom_bar(mapping = aes(x = rowname, y = count), stat = "identity")+ theme(axis.text.x = element_text(angle = 30)) + scale_x_discrete(name ="Name of Action")
...
ggplot(ordered) + geom_bar(mapping = aes(x = reorder(Scientific.name, tally), y = tally), stat = "identity") + theme(axis.text.x = element_text(angle = 90)) + scale_x_discrete(name ="Species") + scale_y_continuous(name ="# of partners working on species")
