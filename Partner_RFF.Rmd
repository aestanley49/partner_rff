...
#Total number of partners
length(names(PartnerData[,-c(1:2)])) # I counted how many columns there were if i didn't look at columns 1 and 2 ## 236 unique partners
#length(unique(names(PartnerData[,-c(1:2)]))) # just making sure that there are no repeats. ## 236 so its ok
```
...
PartnerData[,c(2,239)] # this is the dataset with names and numbers of species. It does not print out in a convenient format. probably should save and make a better table.
