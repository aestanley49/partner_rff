...
Annabelle to do : write figures to jpg or tiff 
...
node.size<-setNames(c(14,11,12,34,9,10,5,4,4,5,18,6), c("BLM","FO","USFS","USFWS","P","SL","SG","R","M","C","SW","N"))
...
node.size<-setNames(c(0,3,1,6,1,0,1,4,3,2,0), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(0,5,0,9,0,0,1,2,5,6,4), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(7,6,4,16,1,7,12,14,15,14,6), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(1,4,0,12,0,5,2,6,9,7,4), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(1,6,4,10,1,12,15,13,13,22,15), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(1,2,1,7,1,5,2,6,8,7,1), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(0,0,1,4,1,2,2,3,5,6,2), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(0,2,0,0,0,0,0,1,1,2,1), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(0,1,0,2,0,1,0,0,2,2,3), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
...
node.size<-setNames(c(3,2,0,12,0,5,5,5,10,7,5), c("Law","Species Management", "Awareness","Land Water Management","Econ","Education", "Policy", "Research", "Conservation Planning","Instiutional Development", "Funding"))
