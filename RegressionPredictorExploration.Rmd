...
center <- center[-which(is.na(center$XCoord)),]
...
vif(lm(data = new))
  #none are above 5
#not sure what the best way to set this up is? 
vif(lm(total ~ area_x +percentpublic + taxa + nsumemploy + total_x_x,data = new))
vif(lm(total ~ area_x +percentpublic + taxa + nsumemploy, data = new))
vif(lm(total ~ area_x +percentpublic + taxa, data = new))

vif(lm(total ~ area_x +percentpublic + taxa + nsumemploy + total_x_x, data = new))
vif(lm(total ~ percentpublic + taxa + nsumemploy + total_x_x, data = new))
vif(lm(total ~ taxa + nsumemploy + total_x_x, data = new))
