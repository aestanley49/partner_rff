...
dim(west)
west <- west[,-which(colSums(west[,-c(1:4)]) == 0)] #removed columns with all 0s
...
east %>% filter_all(east, any_vars(. != 0))
east <- east[,-which(colSums(east[,-c(1:4)]) == 0)] #removed columns with all 0s
