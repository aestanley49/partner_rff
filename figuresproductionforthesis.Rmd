...
ggplot(data = explore, mapping = aes(x=rssum)) + geom_bar() + scale_x_continuous(name ="Number of Partner", limits=c(-1,175)) + scale_y_continuous(name ="Frequency", limits=c(0,50))
...
ggplot(data = filt, mapping = aes(x=rssum)) + geom_bar() + scale_x_continuous(name ="Number of Partner", limits=c(-1,40)) + scale_y_continuous(name ="Frequency", limits=c(0,20))
...
and <- explore %>% left_join(explore, species_per_partner, by = "X1" )
...
ggplot(data = explore, mapping = aes(x=number_of_species_per_partner, y=Number_of_partnerships_per_partner)) + geom_point()
