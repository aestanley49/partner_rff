...
```{r}
lm1 <- lm(log(Partners) ~ vert + percentpublic + Area + shannon_h + Threats, data=allnumbers)
...
```{r}
lm2 <- lm(log(Partners) ~ plants + percentpublic + Area + Employment + Threats, data=allnumbers)
