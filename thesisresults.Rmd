...
#file names need and which rmd they are located in (can write these into new csvs when done with everything and then call them in)

combo #correlation matrix 
adjmatrix
PartnerData
...
#change names in PredictAndResponsePixel
...
![Map of all species]("/partner_rff/map_all_figures.pdf")
